        ...
        <div className={`border rounded-2xl w-full mt-7 p-6 shadow-sm ${isDark
            ...
            <div className='flex flex-col sm:flex-row gap-3 w-full mt-3'>
                <select
                    ...
                    className={`border-2 rounded-xl px-3 py-2 focus:outline-none transition-colors duration-200 w-full ${isDark
                    ...
                    <option value="Health" className={``}>Health</option>
